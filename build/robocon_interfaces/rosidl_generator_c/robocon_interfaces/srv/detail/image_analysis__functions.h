...
#ifndef ROBOCON_INTERFACES__SRV__DETAIL__IMAGE_ANALYSIS__FUNCTIONS_H_
#define ROBOCON_INTERFACES__SRV__DETAIL__IMAGE_ANALYSIS__FUNCTIONS_H_
...
#include "robocon_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "robocon_interfaces/srv/detail/image_analysis__struct.h"

/// Initialize srv/ImageAnalysis message.
/**
...
/// Create srv/ImageAnalysis message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robocon_interfaces__srv__ImageAnalysis_Request__init().
...
/// Destroy srv/ImageAnalysis message.
/**
 * It calls
 * robocon_interfaces__srv__ImageAnalysis_Request__fini()
...
/// Check for srv/ImageAnalysis message equality.
/**
...
/// Copy a srv/ImageAnalysis message.
/**
...
/// Initialize array of srv/ImageAnalysis messages.
/**
...
/// Finalize array of srv/ImageAnalysis messages.
/**
 * It calls
 * robocon_interfaces__srv__ImageAnalysis_Request__fini()
...
/// Create array of srv/ImageAnalysis messages.
/**
 * It allocates the memory for the array and calls
 * robocon_interfaces__srv__ImageAnalysis_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ImageAnalysis messages.
/**
 * It calls
 * robocon_interfaces__srv__ImageAnalysis_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ImageAnalysis message array equality.
/**
...
/// Copy an array of srv/ImageAnalysis messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robocon_interfaces__srv__ImageAnalysis_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robocon_interfaces
...
/**
 * It calls
 * robocon_interfaces__srv__ImageAnalysis_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robocon_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robocon_interfaces__srv__ImageAnalysis_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robocon_interfaces
...
/**
 * It calls
 * robocon_interfaces__srv__ImageAnalysis_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOCON_INTERFACES__SRV__DETAIL__IMAGE_ANALYSIS__FUNCTIONS_H_
